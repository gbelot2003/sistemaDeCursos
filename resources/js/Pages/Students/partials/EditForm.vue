...
let destroy = ()  => {
    if(confirm("Se dispone a eliminar este registro permanenetemente") == true) {
        form.post(`/estudiantes-destroy/${props.student.id}`)
    }
}
    ...
    <div class="md:grid md:grid-cols-3 md:gap-6 mb-7">
        <div class="md:col-span-1 flex justify-between">
            <div class="px-4 sm:px-0">
                ...
                <p class="mt-1 text-sm text-gray-600">Actualizar datos de Estudiante</p>
            </div>
        </div>
                    ...
                    <div class="grid grid-cols-6 gap-6">
                        ...
                        <div class="col-span-6 sm:col-span-4">
                            ...
                            <Multiselect v-model="form.cursos" :options="cursos" :close-on-select="false"
                                @select="cursos.map(curso => {curso})" label="nombre"
